...
document.addEventListener("touchstart", (e)=>{
    if(!isClicked) functionOnClick(e)
},false);
...
function getIll() {
    ...
    patho.forEach((patho, index) => {
        mydiv.insertAdjacentHTML("beforeend", `<section id="ill-${index}" class="ill">
    <h3>
        <a href="#maladie-${index}" class="ill__name">
            ${patho.name}
        </a>
    </h3>
